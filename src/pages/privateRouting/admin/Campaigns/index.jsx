...
function User() {
  ...
  const [showFilesImportedIndex, setShowFilesImportedIndex] = useState(null);

  const handleResetUploadModal = () => {
    setIsUploadModalOpen(false);
    services?.setBulkUploadResult([]);
  };
  ...
  return (
    <div className={classes.root}>
      <Header classes={classes} text="Campaigns" />
          ...
          >
            {(openForm?.divType === "add" ||
              ...
              <AEVForm
                ...
                handleOpenBulkUploadModal={handleOpenBulkUploadModal}
                handleResetUploadModal={handleResetUploadModal}
                isUploadModalOpen={isUploadModalOpen}
                showFilesImportedIndex={showFilesImportedIndex}
                setShowFilesImportedIndex={setShowFilesImportedIndex}
              />
            )}
